            ...
            <div className="flex gap-4 mt-6">
              {[
                ...
                <a
                  ...
                  className={`w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:bg-[#e30614] hover:text-white transition-all duration-300 hover:scale-110 hover:rotate-6 ${
      ...
      >
        <div className="section-container py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/90 text-sm">
            © {new Date().getFullYear()} dipromotions. Todos los derechos reservados.
          </p>
          <Link 
            to="/nota-legal"
