// =============================================
// PÁGINA DE CHECKOUT - diPromotions
// =============================================
        ...
        <div className="section-container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-2">
              Tu número de pedido es: <span className="font-semibold">#{Date.now().toString().slice(-8)}</span>
            </p>
            <p className="text-gray-600 mb-8">
              Hemos enviado un email de confirmación a <span className="font-semibold">{formData.email}</span>
            </p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm mb-8 text-left">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[#e30614] text-white rounded-full flex items-center justify-center text-sm flex-shrink-0">1</div>
                  <span className="text-gray-600">Recibirás un email con los detalles de tu pedido</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[#e30614] text-white rounded-full flex items-center justify-center text-sm flex-shrink-0">2</div>
                  <span className="text-gray-600">Nuestro equipo te contactará para confirmar la personalización</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[#e30614] text-white rounded-full flex items-center justify-center text-sm flex-shrink-0">3</div>
                  <span className="text-gray-600">Te enviaremos una muestra digital antes de producción</span>
                </li>
              </ul>
            </div>
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div className="section-container py-4">
          <div className="flex items-center justify-between">
            <Link to="/carrito" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors">
              ...
              <div key={s.id} className="flex items-center">
                ...
                {index < steps.length - 1 && (
                  <div className={`w-12 h-0.5 mx-2 ${
                    steps.findIndex(x => x.id === step) > index ? 'bg-green-500' : 'bg-gray-200'
                  }`} />
                )}
              </div>
            ))}
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all"
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all"
                        placeholder="Edificio, escalera, etc. (opcional)"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={3}
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all resize-none"
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-4 p-4 border border-gray-200 rounded-xl cursor-pointer hover:border-[#e30614] transition-colors">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500">Recibirás los datos bancarios por email</p>
                      </div>
                    </label>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      <span className="text-sm text-gray-600">
                        He leído y acepto los <Link to="/nota-legal" className="text-[#e30614] underline">términos y condiciones</Link> y la <Link to="/nota-legal" className="text-[#e30614] underline">política de privacidad</Link>.
                      </span>
                    </label>
                  </div>

                  <div className="flex gap-4">
                    <button type="button" onClick={() => setStep('shipping')} className="flex-1 btn-outline py-4">
                      Volver
                    </button>
