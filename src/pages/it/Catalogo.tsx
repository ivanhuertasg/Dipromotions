...
const categories = [
  { id: '1', name: 'Tecnologia', count: 45, image: '/images/cat-usb.jpg' },
  { id: '2', name: 'Borse', count: 28, image: '/images/cat-bag.jpg' },
  { id: '3', name: 'Tessile', count: 89, image: '/images/cat-tshirt.jpg' },
  { id: '4', name: 'Ufficio', count: 67, image: '/images/cat-pen.jpg' },
  { id: '5', name: 'Casa', count: 56, image: '/images/cat-mug.jpg' },
  { id: '6', name: 'Ecologico', count: 34, image: '/images/product-recycled.jpg' },
];
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-r from-[#e30614] to-[#c7000b] text-white py-12 md:py-16">
        <div className="section-container">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Catalogo</h1>
          <p className="text-xl text-white/90">Scopri la nostra vasta gamma di prodotti promozionali</p>
        </div>
      </div>
      ...
      <div className="py-8">
        <div className="section-container">
          <h2 className="text-xl font-semibold mb-6">Categorie</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((category) => (
              <Link
                key={category.id}
                to={`/it/catalogo?category=${category.id}`}
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-4">
                  ...
                  <p className="text-white/70 text-sm">{category.count} prodotti</p>
                </div>
              </Link>
            ))}
          </div>
      ...
      <div ref={sectionRef} className="py-8 pb-20">
        <div className="section-container">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold">Tutti i prodotti</h2>
            <span className="text-gray-500">{products.length} prodotti</span>
          </div>
