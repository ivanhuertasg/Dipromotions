    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-r from-[#e30614] to-[#c7000b] text-white py-12 md:py-16">
        <div className="section-container">
          <Link to="/it" className="inline-flex items-center gap-2 text-white/80 hover:text-white transition-colors duration-200 mb-6">
            <ArrowLeft className="w-5 h-5" />
            <span>Torna alla home</span>
          </Link>
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Contatti</h1>
          <p className="text-xl text-white/90">Siamo qui per aiutarti</p>
        </div>
      </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Rispondiamo entro 24h</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Spagna</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Lunedì al Venerdì: 9:00 - 18:00</p>
                    <p className="text-gray-500 text-sm">Sabato e Domenica: Chiuso</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input type="text" name="name" required value={formData.name} onChange={handleChange}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all" placeholder="Il tuo nome" />
                    </div>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Email *</label>
                        <input type="email" name="email" required value={formData.email} onChange={handleChange}
                          className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all" placeholder="tuo@email.com" />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <select name="subject" required value={formData.subject} onChange={handleChange}
                        ...
                        <option value="quote">Richiedi un preventivo</option>
                        <option value="order">Domanda su ordine</option>
                        <option value="product">Informazioni prodotto</option>
                    ...
                    <div>
                      ...
                      <textarea name="message" required rows={4} value={formData.message} onChange={handleChange}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all resize-none" placeholder="Come possiamo aiutarti?" />
                    </div>
                    <button type="submit" disabled={isSubmitting}
                      ...
                      {isSubmitting ? (<><div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" /> Invio...</>) : (<><Send className="w-5 h-5" /> Invia messaggio</>)}
                    </button>
                  </form>
                )}
              </div>
