...
const categories = [
  { id: '1', name: 'Technology', count: 45, image: '/images/cat-usb.jpg' },
  { id: '2', name: 'Bags', count: 28, image: '/images/cat-bag.jpg' },
  { id: '3', name: 'Textile', count: 89, image: '/images/cat-tshirt.jpg' },
  { id: '4', name: 'Office', count: 67, image: '/images/cat-pen.jpg' },
  { id: '5', name: 'Home', count: 56, image: '/images/cat-mug.jpg' },
  { id: '6', name: 'Eco-friendly', count: 34, image: '/images/product-recycled.jpg' },
];
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-r from-[#e30614] to-[#c7000b] text-white py-12 md:py-16">
        <div className="section-container">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Catalog</h1>
          <p className="text-xl text-white/90">Explore our wide range of promotional products</p>
        </div>
      </div>
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((category) => (
              <Link
                key={category.id}
                to={`/en/catalogo?category=${category.id}`}
