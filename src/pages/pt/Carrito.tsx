    ...
    return (
      <div className="min-h-screen bg-gray-50 py-16">
        <div className="section-container text-center">
          ...
          <Link to="/pt/catalogo" className="inline-flex items-center gap-2 bg-[#e30614] text-white px-8 py-4 rounded-xl font-semibold hover:bg-[#c7000b] transition-colors">
    ...
    <div className={`min-h-screen bg-gray-50 py-8 transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      <div className="section-container">
        <div className="flex items-center gap-4 mb-8">
          <Link to="/pt/" className="flex items-center gap-2 text-gray-600 hover:text-[#e30614] transition-colors">
            <ArrowLeft className="w-5 h-5" />
            Voltar
          </Link>
          <h1 className="text-2xl md:text-3xl font-bold">O Seu Carrinho ({itemCount})</h1>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm h-fit">
            ...
            <Link to="/pt/checkout" className="block w-full bg-[#e30614] text-white text-center py-4 rounded-xl font-semibold hover:bg-[#c7000b] transition-colors">
              Finalizar compra
            </Link>
            <Link to="/pt/catalogo" className="block w-full text-center py-3 text-gray-600 hover:text-[#e30614] transition-colors mt-4">
              Continuar a comprar
            </Link>
          </div>
        </div>
