    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-r from-[#e30614] to-[#c7000b] text-white py-12 md:py-16">
        <div className="section-container">
          <Link to="/pt" className="inline-flex items-center gap-2 text-white/80 hover:text-white transition-colors duration-200 mb-6">
            <ArrowLeft className="w-5 h-5" />
            <span>Voltar ao início</span>
          </Link>
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Contacto</h1>
          <p className="text-xl text-white/90">Estamos aqui para ajudar</p>
        </div>
      </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Seg - Sex: 9:00 - 18:00</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Respondemos em 24h</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Espanha</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Sábado e Domingo: Fechado</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input type="text" name="name" required value={formData.name} onChange={handleChange}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all" placeholder="O seu nome" />
                    </div>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Email *</label>
                        <input type="email" name="email" required value={formData.email} onChange={handleChange}
                          className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all" placeholder="seu@email.com" />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <select name="subject" required value={formData.subject} onChange={handleChange}
                        ...
                        <option value="order">Questão sobre encomenda</option>
                        <option value="product">Informação de produto</option>
                    ...
                    <div>
                      ...
                      <textarea name="message" required rows={4} value={formData.message} onChange={handleChange}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#e30614] focus:ring-2 focus:ring-[#e30614]/20 outline-none transition-all resize-none" placeholder="Como podemos ajudar?" />
                    </div>
                    <button type="submit" disabled={isSubmitting}
                      ...
                      {isSubmitting ? (<><div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" /> A enviar...</>) : (<><Send className="w-5 h-5" /> Enviar mensagem</>)}
                    </button>
                  </form>
                )}
              </div>
