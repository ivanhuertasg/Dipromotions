...
const categories = [
  ...
  { id: '3', name: 'Têxtil', count: 89, image: '/images/cat-tshirt.jpg' },
  { id: '4', name: 'Escritório', count: 67, image: '/images/cat-pen.jpg' },
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-r from-[#e30614] to-[#c7000b] text-white py-12 md:py-16">
        <div className="section-container">
          ...
          <p className="text-xl text-white/90">Descubra a nossa vasta gama de produtos promocionais</p>
        </div>
      </div>
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((category) => (
              <Link
                key={category.id}
                to={`/pt/catalogo?category=${category.id}`}
