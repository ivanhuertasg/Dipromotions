...
const categories = [
  ...
  { id: '2', name: 'Sacs', count: 28, image: '/images/cat-bag.jpg' },
  { id: '3', name: 'Textile', count: 89, image: '/images/cat-tshirt.jpg' },
  { id: '4', name: 'Bureau', count: 67, image: '/images/cat-pen.jpg' },
  { id: '5', name: 'Maison', count: 56, image: '/images/cat-mug.jpg' },
  { id: '6', name: 'Écologique', count: 34, image: '/images/product-recycled.jpg' },
];
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-r from-[#e30614] to-[#c7000b] text-white py-12 md:py-16">
        <div className="section-container">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Catalogue</h1>
          <p className="text-xl text-white/90">Découvrez notre large gamme de produits promotionnels</p>
        </div>
      </div>
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((category) => (
              <Link
                key={category.id}
                to={`/fr/catalogo?category=${category.id}`}
