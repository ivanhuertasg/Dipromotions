    ...
    return (
      <div className="min-h-screen bg-gray-50 py-16">
        <div className="section-container text-center">
          ...
          <h1 className="text-3xl font-bold mb-4">Ihr Warenkorb ist leer</h1>
          <p className="text-gray-600 mb-8">Fügen Sie Produkte hinzu, um zu beginnen</p>
          <Link to="/de/catalogo" className="inline-flex items-center gap-2 bg-[#e30614] text-white px-8 py-4 rounded-xl font-semibold hover:bg-[#c7000b] transition-colors">
    ...
    <div className={`min-h-screen bg-gray-50 py-8 transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      <div className="section-container">
        <div className="flex items-center gap-4 mb-8">
          <Link to="/de/" className="flex items-center gap-2 text-gray-600 hover:text-[#e30614] transition-colors">
            <ArrowLeft className="w-5 h-5" />
            Zurück
          </Link>
          <h1 className="text-2xl md:text-3xl font-bold">Ihr Warenkorb ({itemCount})</h1>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm h-fit">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">MwSt (21%)</span>
            ...
            <Link to="/de/checkout" className="block w-full bg-[#e30614] text-white text-center py-4 rounded-xl font-semibold hover:bg-[#c7000b] transition-colors">
              Zur Kasse
            </Link>
            <Link to="/de/catalogo" className="block w-full text-center py-3 text-gray-600 hover:text-[#e30614] transition-colors mt-4">
              Weiter einkaufen
            </Link>
          </div>
        </div>
