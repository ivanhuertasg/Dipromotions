...
export const NotaLegalES = () => (
  <PageTemplate title="Nota Legal" description="Información legal sobre el uso de nuestra web y condiciones de servicio.">
    <div className="prose max-w-none">
      <h3 className="text-xl font-semibold text-gray-900 mb-4">1. Información General</h3>
      <p className="text-gray-600 mb-4">En cumplimiento de la Ley 34/2002, de 11 de julio, de servicios de la sociedad de la información y de comercio electrónico, le informamos que el titular de esta web es DIPROMOTIONS DIGARCO & ASOCIADOS, S.L.</p>
      <h3 className="text-xl font-semibold text-gray-900 mb-4">2. Condiciones de Uso</h3>
      <p className="text-gray-600 mb-4">El acceso y uso de este sitio web atribuye la condición de usuario, y se entiende que acepta las condiciones de uso establecidas. El usuario se compromete a hacer un uso adecuado de los contenidos y servicios ofrecidos.</p>
      <h3 className="text-xl font-semibold text-gray-900 mb-4">3. Propiedad Intelectual</h3>
      <p className="text-gray-600 mb-4">Todos los contenidos de esta web, incluyendo imágenes, textos, gráficos y logotipos, son propiedad de DIPROMOTIONS o se utilizan con autorización de sus respectivos propietarios.</p>
      <h3 className="text-xl font-semibold text-gray-900 mb-4">4. Protección de Datos</h3>
      <p className="text-gray-600 mb-4">Los datos personales proporcionados serán tratados de conformidad con el Reglamento General de Protección de Datos (RGPD). Puede ejercer sus derechos de acceso, rectificación, supresión, oposición, limitación y portabilidad.</p>
    </div>
  </PageTemplate>
);
